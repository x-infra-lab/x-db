...
public class PhysicalStreamAgg implements PhysicalPlan {
    ...
    public PhysicalStreamAgg(PhysicalPlan child, List<Expression> groupByExprs,
    ...
    @Override
    public double estimatedCost() { return child.estimatedCost() + child.estimatedRowCount() * 0.5; }
